...
const CRITICAL = `
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  :root {
    --bg:#0a0c12; --card:#141720; --card2:#1a1e2d; --card3:#1f2438;
    --border:#252a3d; --border2:#2e3452; --accent:#f59e0b; --accent2:#fbbf24;
    --text:#edf0f7; --muted:#6b7490; --muted2:#404764;
    --green:#10b981; --red:#ef4444; --blue:#3b82f6;
  }
  html, body, #root {
    height: 100%; background: #0a0c12 !important; color: #edf0f7 !important;
  ...
  /* Mobile: no sidebar margin, padding for topbar */
  ...
  input, select, textarea {
    width: 100%; background: #1a1e2d; border: 1px solid #252a3d;
    color: #edf0f7; padding: 10px 13px; border-radius: 9px;
  ...
  th { padding: 12px 16px; font-size: 11px; font-weight: 700; color: #6b7490;
       text-transform: uppercase; letter-spacing: .6px; text-align: left;
       border-bottom: 1px solid #252a3d; background: #1a1e2d; }
